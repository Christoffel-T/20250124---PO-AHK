...
class TraderBot {
    ...
    check_trade_closed() {
        if (this.trade_opened[1]) {
            ...
            sleep 50 
            loop 3 {
                if PixelSearch(&x, &y, this.coords.detect_trade_open1.x, this.coords.detect_trade_open1.y, this.coords.detect_trade_open2.x, this.coords.detect_trade_open2.y, this.colors.green2, 75) {
                    return
                }
                sleep 50
            }
