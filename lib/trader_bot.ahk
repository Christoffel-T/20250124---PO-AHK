...
class TraderBot {
    __New(settings_obj) {
        ...
        this.qualifiers.loss_amount_modifier := {balance: this.balance.starting, streak: -3, state: 0, state2: 0, amount: 1, amount_2: 1, amounts: [22.93, 47.86, 1.6]}
        ...
        TradeLose() {
            ...
            if this.qualifiers.1_5_state.state = 2 and this.stats.streak = -3 {
                ...
                if this.stats.streak = -2 {
                    ...
                    if this.qualifiers.loss_amount_modifier.state2 = 0 {
                        this.qualifiers.loss_amount_modifier.amount := (0.10*(this.stats.max_bal_diff)) / 0.92
                        this.qualifiers.loss_amount_modifier.state2 := 1
                    } else if this.qualifiers.loss_amount_modifier.state2 = 1 {
                        this.qualifiers.loss_amount_modifier.amount := this.qualifiers.loss_amount_modifier.amount*2+1
                    }
                    this.amount := this.qualifiers.loss_amount_modifier.amount
                } else {
        ...
        Loop {
            ...
            if this.qualifiers.1_5_state.state = 3 {
                if this.stats.trade_history[1] = 'win' and this.stats.trade_history[2] = 'lose' and this.stats.trade_history[3] = 'win' {
                    ...
                    this.qualifiers.loss_amount_modifier.amounts := [37.93, 62.86, 1.6]
                }
    ...
    QualifiersReset() {
        ...
        this.qualifiers.loss_amount_modifier := {balance: this.balance.starting, streak: -3, state: 0, state2: 0, amount: 1, amount_1: 1, amount_2: 1, amounts: [22.93, 47.86, 1.6]}
