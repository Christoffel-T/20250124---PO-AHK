...
class TraderBot {
    ...
    CheckPayout(change_anyway := false) {
        ...
        Loop {
            ...
            if not change_anyway and (this.stats.streak != coin_change_streak or not this.state.coin_change_streak) and ImageSearch(&outx, &outy, this.coords.Payout.x, this.coords.Payout.y, this.coords.Payout.x+this.coords.Payout.w, this.coords.Payout.y+this.coords.Payout.h, '*30 payout.png') {
                this.payout := 92
                break
            } else {
                change_anyway := false
