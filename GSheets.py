...
def monitor_log(file_path):
    header_text = 'date,time,active_trade,amount,E,F,G,H,Streak,max_diff,side_bal,new_col2W,new_col2L,balance,next_target,last_trade,payout,Streaks,OHLC,debug'
