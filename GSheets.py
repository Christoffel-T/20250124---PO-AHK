...
def monitor_log(file_path):
    header_text = 'date,time,active_trade,amount,E,F,G,H,Streak,max_diff,side_bal,new_col,balance,next_target,last_trade,payout,Streaks,double_stats,OHLC,debug'
